                ...
                <div className="flex ml-auto">
                    <a href className="flex flex-row items-center">
                        ...
                        <span className="flex flex-col ml-2">
                            <span className="w-auto font-semibold leading-none tracking-wide truncate">{LoginName}</span>
                            <span className="w-20 mt-1 text-xs leading-none text-gray-500 truncate">นักเรียน</span>
                        </span>
                    </a>
                </div>
            </div>
