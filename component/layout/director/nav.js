...
function Nav() {
    ...
    useEffect(async() => {
        let data = await getDetailteacher("T001")
            ...
            <div className="header-content flex items-center flex-row">
                ...
                <div className="flex ml-auto">
                    <a href className="flex flex-row items-center">
                        <img
                            src="/img-director/director_1.png"
                            alt=""
                        ...
                        <span className="flex flex-col ml-2">
                            ...
                            <span className="truncate w-20 text-gray-500 text-xs leading-none mt-1">ผู้อำนวยการ</span>
                        </span>
                    </a>
                </div>
            </div>
