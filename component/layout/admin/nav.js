...
function Nav() {
    ...
    // localStorage.getItem('LoginId') == "undefined" ?  "" : localStorage.getItem('LoginId') 
    // console.log('log-Main_teacher', localStorage.getItem('LoginId'))

    useEffect(async () => {
      
        let data = await getDetailteacher(localStorage.getItem('LoginId'))
        // let data = await getDetailteacher(localStorage.getItem('LoginId'))
        // let data = await getDetailstudent(localStorage.getItem('LoginId'))
                ...
                <div className="flex ml-auto">
                    <a href className="flex flex-row items-center">
                        ...
                        <span className="flex flex-col ml-2">
                            ...
                            <span className="truncate w-20 text-gray-500 text-xs leading-none mt-1">ผู้ดูแล</span>
                        </span>
                    </a>
                </div>
            </div>
