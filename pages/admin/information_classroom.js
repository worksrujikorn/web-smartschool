                ...
                <main className="main w-4/5 flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
                    ...
                    <div className="main-content flex flex-col flex-grow ">
                        ...
                        <div className="flex flex-col pl-2">
                            <div className="   text-xl text-left  w-full">ข้อมูลของห้องเรียน</div>
                            ...
                            <div className="px-1 w-full text-left">
                                <table className="w-full ">
                                    <tr className=" bg-gray-300 ">
                                        ...
                                        <th className="py-2 text-gray-500 w-2/12  text-center" >ชั้น</th>
                                        <th className="py-2 text-gray-500 w-2/12" >รายละเอียด</th>
                                            ...
                                            <div className="flex flex-col  w-full px-2  ">
                                                ...
                                                <div className="flex flex-col mb-4">
                                                    <div className="flex flex-row  mt-2 ">
                                                        <label className="mb-2 pl-1 font-bold text-lg text-gray-900  w-1/3" for="first_name">รหัสห้องเรียน</label>
                                                        <label className="ml-2 mb-2 pl-1 font-bold text-lg text-gray-900  w-2/3" for="first_name">ชั้น</label>
                                                    </div>
                                                    ...
                                                    <div className="flex flex-row mt-2 ">
                                                        <span className=" w-1/3" >
                                                            {CheckClassroom_Code != null ?
                                                                CheckClassroom_Code == 0 ? <label className=" pl-1  text-sm text-red-600  " for="first_name">มีข้อมูลนี้อยู่แล้ว</label>
                                                                    : CheckClassroom_Code == 1 ? <label className=" pl-1  text-sm text-green-600  " for="first_name">สามารถใช้ได้</label>
                                                                        : <></>
                                                                :
                                                                <></>
                                                            }
                                                        ...
                                                        <span className=" w-1/3">
                                                            {CheckClassroom_Name != null ?
                                                                CheckClassroom_Name == 0 ? <label className=" pl-1  text-sm text-red-600  " for="first_name">มีข้อมูลนี้อยู่แล้ว</label>
                                                                    : CheckClassroom_Name == 1 ? <label className=" pl-1  text-sm text-green-600  " for="first_name">สามารถใช้ได้</label>
                                                                        : <></>
                                                                :
                                                                <></>
                                                            }</span>
                                            ...
                                            <div className="flex flex-col  w-full px-2  ">
                                                ...
                                                <div className="flex flex-col mb-4">
                                                    ...
                                                    <div className="flex flex-row mt-2 ">
                                                        ...
                                                        <span className=" w-1/3">
                                                            {CheckClassroom_Name != null ?
                                                                CheckClassroom_Name == 0 ? <label className=" pl-1  text-sm text-red-600  " for="first_name" value="">มีข้อมูลนี้อยู่แล้ว</label>
                                                                    : CheckClassroom_Name == 1 ? <label className=" pl-1  text-sm text-green-600  " for="first_name">สามารถใช้ได้</label>
                                                                        : <></>
                                                                :
                                                                <></>
