...
import { get_group_all, create_group, delete_group, update_group } from "../../action/admin"
...
function add_group_department() {
    ...
    const EditClick = async (i) => {
        ...
        console.log('GroupMap', GroupMap[i])
        setValues({ ...GroupMap[i] })
    ...
    const search = (e) => {
        async function getdatapersondate_() {
            ...
            let data = await get_group_all()
            console.log(data)
            check = data
            if (data) {
                var matches = check.filter(function (x) {
                    return x.group_code?.toUpperCase().includes(event) || x.group_name?.toUpperCase().includes(event) || x.detail?.toUpperCase().includes(event)
                });
                search = matches
            }
            if (e.target.value != "") {
    ...
    const SaveClick = async () => {
        ...
        if (Showmodaleadd) {
            data = await create_group(save)
        }
        else {
            data = await update_group(save)
        }
                ...
                <main className="main w-4/5 flex flex-col flex-grow -ml-64 md:ml-0 transition-all duration-150 ease-in">
                    ...
                    <div className="main-content flex flex-col flex-grow ">
                        ...
                        <div className="flex flex-col pl-2">
                            <div className="   text-xl text-left  w-full">ข้อมูลกลุ่มสาระการเรียนรู้</div>
                            <div className="flex flex-row w-full">

                                <div className="   text-base text-left   my-2   w-1/5  ">
                                    <input onChange={(e) => search(e)} className=" p-2 border-solid  border border-gray-300 outline-none  rounded-lg shadow w-full " placeholder="ค้นหากลุ่มสาระการเรียนรู้" />
                                </div>
                            ...
                            <div className="px-1 w-full text-left">
                                <table className="w-full ">
                                    <tr className=" bg-gray-300 ">
                                        ...
                                        <th className="py-2 text-gray-500 w-2/12  text-center" >รหัสกลุ่มสาระ</th>
                                        <th className="py-2 text-gray-500 w-2/12 text-center" >ชื่อกลุ่ม</th>
                                        <th className="py-2 text-gray-500 w-2/12 text-center" >รายละเอียด</th>
                                        <th className="py-2 text-gray-500 w-2/12 text-center" >เพิ่มโดย
                                    ...
                                    {(GroupMap) ? GroupMap.map((p, index) => (
                                        <tr key={index + 1} className="border border-gray-300">
                                            ...
                                            <td className="py-2 text-center ">{p.group_code}</td>
                                            <td className="py-2 text-center">{p.group_name}</td>
                                            ...
                                            <td className="w-1/12  ">
                                                <button
                                                    ...
                                                    type="button"
                                                    onClick={() => DeleteClick(p.group_id)}
                                                >
                                                    <div className="flex flex-row items-center justify-center content-center    ">
                                                        <svg
                                                            fill="none"
                                            ...
                                            <div className="flex flex-col  w-full px-3  ">
                                                ...
                                                <div className="flex flex-col mb-4">
                                                    <div className="flex flex-row  mt-2 ">
                                                        <label className="mb-2 pl-1 font-bold text-lg text-gray-900  w-1/3" for="first_name">รหัสกลุ่มสาระ</label>
                                                        <label className="ml-2 mb-2 pl-1 font-bold text-lg text-gray-900  w-2/3" for="first_name">ชื่อกลุ่มกลุ่มสาระ</label>
                                                    </div>
                                                    <div className="flex flex-row">
                                                        <input className=" py-2 px-3 border-solid  border border-gray-300 outline-none  rounded-lg shadow w-1/3" type="text" onChange={(e) => handleChange('group_code', e)} />
                                                        <input className="ml-2 py-2 px-3 border-solid  border border-gray-300 outline-none  rounded-lg shadow w-2/3" type="text" onChange={(e) => handleChange('group_name', e)} />
                                                ...
                                                <div className="flex flex-col mb-4">
                                                    <div className="flex flex-row">
                                                        <label className=" ml-2 mb-2 pl-1 font-bold text-lg text-gray-900  w-1/2" for="first_name">รายละเอียด</label>
                                        ...
                                        <>
                                            <div className="flex flex-col  w-full px-3  ">
                                                ...
                                                <div className="flex flex-col mb-4">
                                                    ...
                                                    <div className="flex flex-row">
                                                        <input className=" py-2 px-3 border-solid  border border-gray-300 outline-none  rounded-lg shadow w-1/3" type="text" onChange={(e) => handleChange('group_code', e)} value={values.group_code} />
                                                        <input className="ml-2 py-2 px-3 border-solid  border border-gray-300 outline-none  rounded-lg shadow w-2/3" type="text" onChange={(e) => handleChange('group_name', e)} value={values.group_name} />
                                                ...
                                                <div className="flex flex-col mb-4">
                                                    <div className="flex flex-row">
                                                        <label className=" ml-2 mb-2 pl-1 font-bold text-lg text-gray-900  w-1/2" htmlFor="">รายละเอียด</label>
...
export default add_group_department
