                    ...
                    <div className="ml-12">
                        <div className="main-content flex flex-col flex-grow p-4 ">
                            ...
                            <div className="flex flex-col flex-grow  rounded-lg mt-4  border-blue-800  border-2 h-4/6">
                                ...
                                <div className="flex flex-col overflow-x-auto overflow-y-auto h-full mb-2 transition-all">
                                    {newsmap ? newsmap.map((p, index) => (
                                        <button key={index + 1} className="border-blue-800  border-2 mt-4 py-4 mx-4 rounded-lg px-4  hover:bg-blue-800 hover:text-white text-color-blue transition-all" onClick={() => newsclick(index)} type="button">
