        ...
        <main className="flex flex-col flex-grow w-full transition-all duration-150 ease-in md:w-4/5 main md:ml-0">
          ...
          <div className="ml-12">
            <div className="main-content flex flex-col flex-grow p-4 ">
              ...
              <h1 className="   text-xl text-center text-color-blue mb-4">
                แจ้งลาหยุด
              </h1>
              {valuesPost ? (
                <>
                  <div className="flex flex-col-reverse w-full h-full sm:flex-row  md:flex-row lg:flex-row">
                    <div className="  lg:w-1/2 sm:w-full  border-2  border-blue-800 p-4  m-1  rounded  ">
                      ...
                      <div className="flex flex-row mb-1  w-full">
                        <div className="switch-field flex flex-row w-full">
                          ...
                          <div className="xl:w-1/4 text-center  sm:w-2/4">
                            ...
                            <label
                              htmlFor="Day"
                              className=" mr-2  text-color-blue"
                            >
                              เต็มวัน
                            </label>
                          </div>
                          ...
                          <div className="xl:w-1/4 text-center sm:w-2/4">
                            <input
                              ...
                              onClick={() => hours()}
                            />
                            <label htmlFor="Hours " className="text-color-blue">
                              {" "}
                              รายชั่วโมง
                            </label>
                          </div>
                        ...
                        {Day ? (
                          <div className="flex flex-col text-center ">
                            <div className="flex flex-row items-center ">
                              ...
                              <div className=" w-1/6 text-color-blue">จาก</div>

                              <div className="text-center">
                                <DatePicker
                                  minDate={new Date()}
                                  selected={new Date(valuesPost.leave_from)}
                                  onChange={(e) =>
                                    handleChange("leave_from", e)
                                  }
                                  className=" text-center text-blue-800 border-2 border-blue-800 p-2 m-2 rounded-lg  outline-none w-full "
                                />
                              </div>
                            ...
                            <div className="flex flex-row items-center">
                              <div className=" w-1/6"></div>
                              <div className=" w-1/6 text-color-blue">ถึง</div>

                              <div className="text-center">
                                <DatePicker
                                  minDate={new Date()}
                                  selected={new Date(valuesPost.leave_to)}
                                  onChange={(e) => handleChange("leave_to", e)}
                                  className=" text-center text-blue-800 border-2 border-blue-800 p-2 m-2 rounded-lg  outline-none  w-full "
                                />
                              </div>
                              <div className=" w-1/6"></div>
                            ...
                            <div className="flex flex-row items-center ">
                              ...
                              <div className="text-center">
                                <DatePicker
                                  ...
                                  className=" text-center text-blue-800 border-2 border-blue-800 p-2 m-2 rounded  outline-none "
                                />
                              </div>
                              <div className="w-1/2 flex flex-row">
                                <input
                                  type="time"
                                  onChange={(e) => timechange("first", e)}
                                  className="text-center text-blue-800 border-2 border-blue-800 p-2 m-2 rounded  outline-none"
                                />
                              </div>
                      ...
                      <div className="flex flex-col ">
                        <select
                          className="rounded  p-1  border-2 border-blue-800 text-color-blue outline-none"
                          value={valuesPost.category_code}
                          onChange={(e) => handleChange("category_code", e)}
                        >
                          {dropdown
                            ? dropdown.map((p, index) => (
                              <option key={index + 1} value={p.category_code}>
                                {p.category_name}
                              </option>
                            ))
                            : ""}
                    ...
                    <div className="border-2 border-blue-800 m-1    rounded sm:w-full lg:w-1/2">
                      <button
                        type="button"
                        className=" w-full h-full mr-2   text-center bg-blue-800  "
                        onClick={() => detailshow()}
                      >
                        <div className=" h-2/6 text-white pt-10 text-xl ">
                          วันลาสะสม
                        </div>
                        <div className=" md:text-8xl  lg:text-8xl sm:text-8xl text-8xl h-4/6 m-auto   pb-10 text-white">
                          {valueCount ? valueCount : <h1>ไม่มีข้อมูล</h1>}
                        </div>
                      </button>
                    </div>
                  </div>
                  <div className="flex flex-col w-full  h-3/6   ">
                    <div className="  h-full flex flex-col p-4 text-color-blue border-2  border-blue-800 m-1    rounded">
                      ...
                      <div className="mt-4">
                        <textarea
                          value={valuesPost.detail}
                          onChange={(e) => handleChange("detail", e)}
                          name=""
                          id=""
                          cols="30"
                          rows="10"
                          className="rounded w-full resize-none border-2 border-blue-800  focus:border-blue-800 focus:border-2 outline-none"
                        ></textarea>
                      </div>
                    </div>
                  </div>
                      ...
                      <div className="relative px-6 flex-auto ">
                        <table className="rounded-t-lg m-5  w-full mx-auto bg-blue-200 text-blue-800">
                          <tr className=" border-b-2 border-blue-300 text-center">
                            ...
                            <th className="px-6 py-3">เวลาที่ลา</th>
                          ...
                          {values ? (
                            values.map((p, index) => (
                              <tr
                                key={index + 1}
                                className="bg-blue-100 border-b border-blue-200 text-center"
                              >
