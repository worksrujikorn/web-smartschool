                        ...
                        {classroomlevelmap
                          ? classroomlevelmap.map((p, index) => (
                              <option value={p.classroom_level}>
                                มัธยมศึกษาปีที่{" " + p.classroom_level}
                              </option>
                            ))
                          : ""}
                      </select>
                              ...
                              <div className="flex flex-col  w-full px-2  ">
                                ...
                                <div className="flex flex-col mb-4">
                                  <div className="flex flex-row pl-2 mt-5">
                                    ...
                                    <label
                                      ...
                                      htmlFor="first_name"
                                    >
                                      กรณีผู้ปกครองไม่อยู่บ้าน
                                      ฝากนักเรียนอยู่บ้านกับใคร
                                    </label>
                                  </div>
                                  <div class="flex flex-row pl-2 mt-3">
                                    <div className="  ml-10 text-xl text-left  w-12"></div>
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ด้านการเรียน</span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ด้านพฤติกรรม</span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ด้านเศรษฐกิจ</span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center ">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">เบี้ยผู้สูงอาย</span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">เบี้ยพิการ </span>
                                      </label>
                                    </div>
                                ...
                                <div className="flex flex-col mb-4">
                                  <div className="flex flex-row pl-2 mt-5">
                                    ...
                                    >
                                      สถานะของครัวเรือน
                                      กรอกเฉพาะบุคคลที่อาศัยในบ้านปัจจุบัน
                                    </label>
                                  </div>
                                  <div className="flex flex-row pl-2 mt-5">
                                    <label
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/3">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">มีคนพิการ</span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-left w-1/3">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/3">
                                      ...
                                      <span class="ml-3">
                                        มีคนอายุ 15-65 ปีว่างงาน
                                        (ที่ไม่ใช่นักเรียน/นักศึกษา)
                                      </span>
                                    </div>
                                  </div>
                                </div>
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">บ้านของตนเอง </span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">
                                          สภาพบ้านชำรุดทรุดโทรม หรือ
                                          บ้านทำจากวัสดุพื้นบ้าน เช่น ไม้ไผ่
                                          ใบจากหรือวัสดุเหลือใช้{" "}
                                        </span>
                                      </label>
                                    </div>
                                  </div>
                                ...
                                <div className="flex flex-col mb-4">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <span class="ml-3 mt-3" for="farm_land-4">
                                      กรณีที่มีที่ดิน หรือ เช่าที่ดินจำนวน{" "}
                                    </span>
                                    <input
                                  ...
                                  <div class="flex flex-row  pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/2">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">เล่นการพนัน</span>
                                      </label>
                                    </div>
                                  </div>
                                  <div class="flex flex-row  pl-2 mt-3">
                                  ...
                                  <div class="flex flex-row   pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/2">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ไม่มีผู้ดูแล </span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-left w-1/2">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ช่วยงานบ้าน </span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">อ่านหนังสือ </span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">แว้น/สก๊อย</span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ไปสวนสาธารณะ </span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">เล่นดนตรี</span>
                                      </label>
                                    </div>
                                  </div>
                                  <div class="flex flex-row pl-2 mt-3">
                                ...
                                <div className="flex flex-col mb-4">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/3">
                                      ...
                                      <span class="ml-3">ก้าวร้าว เกเร</span>
                                    </div>
                                    <div class="mt-2 flex justify-left w-1/3">
                                      <label class="inline-flex items-center">
                                        <input
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/3">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">ตั้งครรภ์</span>
                                      </label>
                                    </div>
                                  </div>
                                  <div class="flex flex-row pl-2 mt-3">
                                ...
                                <div className="flex flex-col mb-4">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/3">
                                      ...
                                      <span class="ml-3">
                                        ใช้เงินสิ้นเปลือง โกหก
                                        ลักขโมยเงินเพื่อเล่นเกม
                                      </span>
                                    </div>
                                  </div>
                                  <div class="flex flex-row pl-2 mt-3">
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        >
                                          ใช้ Social media/game (ไม่เกินวันละ 3
                                          ชั่วโมง)
                                        </span>
                                      </label>
                                    </div>
                                  ...
                                  <div class="flex flex-row pl-2 mt-3">
                                    ...
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">พ่อเลี้ยง </span>
                                      </label>
                                    </div>
                                    <div class="mt-2 flex justify-center">
                                      <label class="inline-flex items-center">
                                        ...
                                        />
                                        <span class="ml-3">แม่เลี้ยง </span>
                                      </label>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="flex flex-col mb-4">
                                  <div className="flex flex-row w-full  mt-3">
                                    ...
                                    <label
                                      ...
                                      htmlFor="first_name"
                                    >
                                      สถานที่ใกล้เคียง(เช่น
                                      วัดเขียนเขต,โลตัสสำขำรังสิต-นครนำยก)
                                    </label>
                                  </div>
                                  <div className="flex flex-row mb-4">
                                    <label
                                ...
                                <div className="flex flex-col mb-4">
                                  ...
                                  <div className="flex flex-row mb-4">
                                    ...
                                    <div class="mt-2 flex justify-left">
                                      ...
                                      >
                                        บ้านหรือที่พักประเภท วัด มูลนิธิ หอพัก
                                        โรงงาน อยู่กับนายจ้าง
                                      </span>
                                    </div>
                                  </div>
                                  <div className="flex flex-row mb-4">
                                    ...
                                    <div class="mt-2 flex justify-left w-1/2">
                                      ...
                                      >
                                        ภาพนักเรียนและป้ายชื่อโรงเรียน
                                        เนื่องจากถ่ายภาพบ้านไม่ได้ เนื่องจาก
                                        บ้านอยู่ต่างอำเภอ/ต่างจังหวัด/ต่างประเทศ
                                        หรือไม่ได้รับอนุญาตให้ถ่ายภาพ{" "}
                                      </span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div className="flex flex-col mb-4">
                                  <div className="flex flex-row w-full  mt-3">
                                    ...
                                    >
                                      รูปที่ 2
                                      ภาพถ่ายครูที่ปรึกษากับครอบครัวนักเรียน
                                    </label>
                                  </div>
