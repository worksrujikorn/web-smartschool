                    ...
                    <div className="ml-12">
                        <div className="main-content flex flex-col flex-grow p-4">
                            ...
                            <div className="flex flex-col flex-grow  rounded-lg mt-4   pb-4  border-blue-800  border-2  h-auto">
                                <div className="flex flex-col  border-2 border-blue-800 mt-4 mx-4 p-4  rounded-lg text-color-blue   text-left  " type="button">
                                    <div className="flex flex-col">
                                        <div className="flex flex-row mb-2"  >
                                            <div className="w-4/6 ">
                                                ชื่อ : นางสาว อมยิ้ม หวานมาก
                                            </div>
                                            <div className="w-1/6">
                                                ชั้น :  ม.1/1
                                            </div>
                                ...
                                <button id='plus' onClick={() => front()} className="flex flex-col  border-2 border-blue-800 mt-4 mx-4 p-4  rounded-lg text-color-blue   text-left hover:bg-blue-800 hover:text-white" type="button">
                                    ...
                                    <div className="flex flex-row  w-full  items-center ">
                                        ...
                                        <div className=" w-9/12  ml-4 text-left">
                                            แบบประเมินพฤติกรรมเด็ก (SDQ : Strengths and Difficulties Questionnaire) (ฉบับครูเป็นผู้ประเมินนักเรียน)
                                        </div>
                                        ...
                                        <div className="relative p-4  ">
                                            <div className="bg-white   py-8  px-5" >
                                                <div className="text-center mb-2">
                                                    ...
                                                    <br /> (ฉบับครูเป็นผู้ประเมินนักเรียน)
                                                </div>
